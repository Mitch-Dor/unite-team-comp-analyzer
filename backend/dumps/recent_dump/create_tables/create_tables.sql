...
CREATE SEQUENCE public.matches_match_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.pro_events_event_id_seq;

CREATE SEQUENCE public.pro_events_event_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.pro_players_player_id_seq;

CREATE SEQUENCE public.pro_players_player_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.pro_sets_set_id_seq;

CREATE SEQUENCE public.pro_sets_set_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.pro_teams_team_id_seq;

CREATE SEQUENCE public.pro_teams_team_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
